...
export class AdvertService {
  ...
  createBooking(booking) {
    //http://127.0.0.1:8080/MBNWs/rs/bookingExt/createBooking
    return this.http.post(`${Constants.SERVICE_URL}${Constants.SERVICE_PROJECT}bookingExt/createBooking`, booking, this.httpOptions)
         .pipe(map(response => response))
  }
  
  loadBookingDetail(id: string) {
    //http://192.168.123.10:8008/MBNWs/rs/bookingExt/loadBookingDetail/c9d10958-9876-4544-94e0-52ec049b5ed7
    return this.http.get(`${Constants.SERVICE_URL}${Constants.SERVICE_PROJECT}bookingExt/loadBookingDetail/${id}`, this.httpOptions)
    .pipe(map(response => response))
  }
